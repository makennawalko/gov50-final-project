...
x = "LGBT+ Identifier",
y = "Alignment",
title = "Relationship Between LGBT+ Identity Status and Moral Alignment in Marvel Comics",
subtitle = "With 0 Representing Straight, Cis Characters and 1 Representing LGBT+ Characters"
)  +
...
subtitle = "With 0 Representing Male Characters and 1 Representing Female Characters"
)  + 
geom_smooth(method = "lm", se = FALSE, color = "darkslateblue", size = 1.5)
```
##Analysis of ATE & Regression:
