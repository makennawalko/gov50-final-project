...
data2 <- data2 |>
  mutate(
    pre_1970 = if_else(Year <= 1970, 1, 0)
  )
...
labs(
x = "LGBT+ Identity (0 Being Straight & Cis, 1 Being LGBT+)",
...
labs(
x = "Gender Identity (0 Representing Male Characters and 1 Representing Female Characters)",
y = "Alignment on a Scale of 0 (Evil) to 2 (Good)",
